//селекторы
export const cardContainerSelector = '.cards__list';// селектор контейнер карточек в разметке
export const selectorProfileName = '.profile__name';//селектор с именем профиля
export const selectorProfileDesc = '.profile__desc';//селектор с описанием профиля
export const selectorCardTemplate = '.cards-template';//селектор разметки карточки
...
export const BASE_URL = 'https://api.mesto22.nomoredomains.work';